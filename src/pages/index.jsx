...
const IndexPage = () => (
  ...
  >
    ...
    <h2>Objetivos</h2>
    <p>
      Conocer aproximadamente cuántas personas aspiran a ser desarrolladores de
      software o estar involucrados de alguna manera en su producción, así como
      analizar las razones por las que algunos alumnos no quieren perseguir esta
      carrera, las causas, sus posibles repercusiones en el futuro de los
      ingenieros en sistemas egresados del Instituto Tecnológico de Saltillo y
      al menos una manera de incentivar el interés en este redituable campo
      laboral.
    </p>
    ...
    <ul>
      ...
      <li>
        ...
        interesados en aprender sobre programación más aplicada, como diseño de
        interfaces gráficas y desarrollo de programas en cursos y materias
    ...
    <ul>
      <li>
        Determinar la cantidad precisa de estudiantes de Ingeniería en Sistemas
        Computacionales que no se interesen por el desarrollo de software, una
        muestra lo más precisa posible para comprobar si nuestra hipótesis
        inicial es correcta.
      </li>
      <li>
    ...
    <p>
      ...
      inicialmente. Tomando en cuenta los resultados obtenidos, podemos obtener
    ...
    <ul>
      <li>
        ...
        contrario. El área de especialización preferida de los alumnos es la del
        desarrollo y programación, con un 40% de la muestra eligiendo este
      ...
      <li>
        La mayoría de los alumnos de sistemas computacionales no dicen sentirse
        preparados para entrar a laborar en la industria de desarrollo web. Esta
        conclusión es alarmante, dado que las tecnologías web hoy en día son las
        que marcan la pauta del desarrollo tecnológico de software y si el
        instituto no capacita a sus alumnos correctamente, pueden quedarse
      ...
      <li>
        Quienes ponen la ingeniería de software como su última opción tienden a
        hacer esto porque creen que no son buenos programadores. Esto nos indica
        que hay un “temor” hacia la programación que ocasiona que los alumnos no
        quieran ingresar a esa área.
      </li>
      <li>
        Una gran cantidad de los alumnos piensa que el tecnológico tiene el rol
        de enseñar a sus alumnos tecnologías de vanguardia. Este consenso quiere
        decir que de cierta forma ven al tecnológico responsable de su
      ...
      <li>
        ...
        impide que los alumnos quieran escogerla como su opción número uno para
        especializarse. Esto quiere decir que, a pesar de ser un reto obtener
        las habilidades necesarias, los alumnos del tecnológico aspiran a ser
        desarrolladores de aplicaciones y soluciones innovadoras por medio de
        software.
      </li>
    </ul>
    <h2>Fuentes</h2>
    <ol>
      ...
      <li>
        Sommerville, Ian. (2011). Software engineering (9th ed., p. 6). Pearson
        Education Inc. s/l
      </li>
      <li>
        Ruiz de la Peña, J., & Aguilera Cruz, O. (2007).{" "}
        <i>
          Importancia de la Ingeniería de Software en la producción de software.
        </i>{" "}
      ...
      <li>
        ...
        Características - Lifeder. (2018). Lifeder. Obtenida el 3 de mayo de
        2019.
        <a
